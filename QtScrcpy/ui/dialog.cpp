...
Dialog::Dialog(QWidget *parent) : QWidget(parent), ui(new Ui::Widget)
{
    ...
    // NOTE: the first on_updateDevice_clicked() is deliberately deferred until after
    // the adbProcessResult handler below is connected (see further down in this ctor).
